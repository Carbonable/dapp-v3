...
export default function MenuItem({ title, icon, isExternal = false, isUppercase, link, className }: MenuItemProps) {
  ...
  const wrapperClass = cn('flex items-center justify-start py-2 px-4', link && "rounded-full hover:bg-greenish-500 dark:hover:bg-greenish-500 cursor-pointer text-neutral-800 dark:text-neutral-100", className);
